...
export default function AboutMe() {
  ...
  <div className="flex justify-center items-start gap-6 mb-12">
    ...
    <motion.div
      ...
      className="relative w-full md:w-1/2 p-6 bg-white/5 rounded-lg flex flex-col justify-between"
    >
    ...
    >
      <div>
        <h2 className="text-[25px] font-heading font-bold mb-4 text-[#00f0ff] drop-shadow-[0_0_12px_#00f0ff]">My Tech Stack</h2>
        <p>
          I love working with AI/ML, open-source contributions, and building tools that make
